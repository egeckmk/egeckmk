...
const egeckmk = {
  ...
  email: "egeckmk@gmail.com",
    linkedIn: "https://www.linkedin.com/in/egecakmak/",
    instagram: "https://www.instagram.com/egeckmk/",
    twitter: "https://twitter.com/egeckmk",
    website: "www.egeckmk.com",
  workHistory: [
    {
  ...
  technologies: {
    backend: {
      js: ["NodeJS"],
      csharp: ["ASP.NET Core", "ASP.NET 5-6-7-8"]
    },
    frontend: {
      js: ["ReactJS"],
      csharp: ["ASP.NET Razor Pages", "ASP.NET Razor Pages MVC"]
    },
    database: {
      SQL: ["MSSQL", "ORACLE"],
      NOSQL: ["MongoDB"]
